...
![Последняя версия](https://img.shields.io/badge/Последняя_версия-1.92.5-blue)

APT зеркало для [pkgs.tailscale.com](https://pkgs.tailscale.com) ([GitHub](https://github.com/tailscale/tailscale))

### Доступные версии:
- 1.66.0 - 1.92.5 (debian, raspbian, ubuntu)
- 1.84.0 - 1.92.5 (centos, fedora, rhel, amazon linux)
